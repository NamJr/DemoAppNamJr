...
public class MrMs2016Details extends AppCompatActivity {
    CircleIndicator indicator;
    ViewPager pager;
    MrMs2016FragmentAdapter fragmentAdapter;
//    TableLayout tableLayout;
    void Init(){
        indicator = findViewById(R.id.indi);
        pager = findViewById(R.id.viewpager);
        fragmentAdapter = new MrMs2016FragmentAdapter( getSupportFragmentManager());
