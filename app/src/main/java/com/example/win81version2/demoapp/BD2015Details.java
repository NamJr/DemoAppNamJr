...
public class BD2015Details extends AppCompatActivity {
    CircleIndicator indicator;
    ViewPager pager;
    BD2015FragmentAdapter fragmentAdapter;
//    TableLayout tableLayout;
    void Init(){
        indicator = findViewById(R.id.indi);
        pager = findViewById(R.id.viewpager);
        fragmentAdapter = new BD2015FragmentAdapter( getSupportFragmentManager());
