...
public class BG2015Details extends AppCompatActivity {
    CircleIndicator indicator;
    ViewPager pager;
    BG2015FragmentAdapter fragmentAdapter;
//    TableLayout tableLayout;
    void Init(){
        indicator = findViewById(R.id.indi);
        pager = findViewById(R.id.viewpager);
        fragmentAdapter = new BG2015FragmentAdapter( getSupportFragmentManager());
