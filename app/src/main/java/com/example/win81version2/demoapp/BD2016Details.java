...
public class BD2016Details extends AppCompatActivity {
    CircleIndicator indicator;
    ViewPager pager;
    BD2016FragmentAdapter fragmentAdapter;
//    TableLayout tableLayout;
    void Init(){
        indicator = findViewById(R.id.indi);
        pager = findViewById(R.id.viewpager);
        fragmentAdapter = new BD2016FragmentAdapter( getSupportFragmentManager());
