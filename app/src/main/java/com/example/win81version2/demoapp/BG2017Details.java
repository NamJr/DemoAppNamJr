...
public class BG2017Details extends AppCompatActivity {
    CircleIndicator indicator;
    ViewPager pager;
    BG2016FragmentAdapter fragmentAdapter;
//    TableLayout tableLayout;
    void Init(){
        indicator = findViewById(R.id.indi);
        pager = findViewById(R.id.viewpager);
        fragmentAdapter = new BG2016FragmentAdapter( getSupportFragmentManager());
